...
- `$>dmesg -H -x`: \
  <img src="./misc/images/syslog01.png" alt="syslog01" width="700"/>
...
- `$>vim /var/log/syslog`: \
  <img src="./misc/images/syslog02.png" alt="syslog02" width="700"/>
...
- `$>vim /var/log/auth.log`: \
  <img src="./misc/images/syslog03.png" alt="syslog03" width="700"/>
...
- Добавим новое задание для планировщика `cron`: \
  утилита crontab позволяет эксплуатировать crontab файлы для отдельных пользователей, \
  oпция `l` выоводит на экран текущее содержимое `crontab`, \
  опция `u` позволяет задать имя пользователя, с чьим `crontab` будут производиться операции, \
  опция `e` позволяет изменять содержимое `crontab`, \
  утилита `which` выводит полный путь до исполняемого файла \
  <img src="./misc/images/cron01.png" alt="cron01" width="700"/>
- `*/2 * * * * /usr/bin/uptime` означает, что нужно запускать утилиту uptime каждые 2 минуты \
  каждого часа каждого дня каждого месяца любого дня недели: \
  <img src="./misc/images/cron02.png" alt="cron02" width="700"/>
- информация о выполненных заданиях заносится в журнал `/var/log/syslog`:
  <img src="./misc/images/cron03.png" alt="cron03" width="700"/>
- список текущих задач можно отобразить командой `$> crontab -l -u username`:
  <img src="./misc/images/cron04.png" alt="cron04" width="700"/>

#### Удалить все задания из планировщика заданий.

- `$>crontab -r -u username` \
  опция `r` удаляет текущий `crontab` \
  <img src="./misc/images/cron05.png" alt="cron05" width="700"/>

[cron man-page](https://manpages.ubuntu.com/manpages/focal/en/man8/cron.8.html) \
[crontab util man-page](https://manpages.ubuntu.com/manpages/focal/en/man1/crontab.1.html) \
[crontab file man-page](https://manpages.ubuntu.com/manpages/focal/en/man5/crontab.5.html)
